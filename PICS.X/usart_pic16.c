...
void USARTInit(uint16_t baud_rate)
{
    //Setup queue
    UQFront=UQEnd=-1;
    BRGH = 0;		// Modo de Trabajo UART (0 --> baja velocidad)
	BRG16 = 0; // a 1 = 16bits velocidad de transmision. a 0 = 8bits velocidad de transmision
	SPBRGH = 0;
       // 	TX9 = 0;	// Envio de 8/9 bits (0 --> 8 bits)
	//RX9 = 0; //No es necesario activar el 9º bit
    ...
    TXSTAbits.TXEN=0; //Transmit enable
